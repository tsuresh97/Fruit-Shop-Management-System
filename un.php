...
$res=mysql_query("Select * from sur7");
while($rn=mysql_fetch_array($res))
{
$id=$rn['proname'];
$id1=$rn['mobile'];
...
echo"<h1>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspGoogle Fruit Shop</h1>";
...
<button  type=button name=b5 class =button id="btnprint"  value="Print This Page" onclick="print_page()">Generate Bill</button>
</div>
</body>